...
class VacationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vacation" do
    assert_difference('Vacation.count') do
      post vacations_url, params: { vacation: { consultation: @vacation.consultation, hospital_id: @vacation.hospital_id } }
    end
  ...
  test "should update vacation" do
    patch vacation_url(@vacation), params: { vacation: { consultation: @vacation.consultation, hospital_id: @vacation.hospital_id } }
